...
export function MarketEvents({ stockSplits, upcomingEarnings }: MarketEventsProps) {
  ...
  return (
    <section className="mb-12">
      <SectionHeading number="07 / Market Events" title="Market Events" />
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex flex-col flex-1 text-left space-y-2 text-sm">
                ...
                <div className="flex justify-between border-b border-rule-dashed pb-1.5">
                  ...
                  <span className="font-serif font-bold text-right">{upcomingEarnings.revenueEstimate > 0 ? formatCompactCurrency(upcomingEarnings.revenueEstimate) : "N/A"}</span>
                </div>
                    ...
                    return (
                      <tr key={i} className="border-b border-rule-dashed last:border-0 hover:bg-paper transition-colors">
                        ...
                        <td className="px-2 py-3 whitespace-nowrap">
                          <span className={`rounded px-2 py-0.5 text-xs font-medium ${isForward ? "text-positive bg-positive/10" : "text-negative bg-negative/10"}`}>
